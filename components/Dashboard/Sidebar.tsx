...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-[260px] transform transition-transform duration-300 ease-in-out lg:static lg:z-auto lg:translate-x-0 ${
      ...
      >
        {/* Brand Header */}
        <div style={{ padding: "24px", paddingBottom: 16, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
